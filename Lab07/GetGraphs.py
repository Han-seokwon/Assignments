...
class GetGraphs:
    ...
    def getG3(self): # weighted directed graph
        g = Graph(True)
        v1 = Vertex("v1")
        v2 = Vertex("v2")
        v3 = Vertex("v3")
    ...
    def getG4_TestConnectedComponents(self):
        sg = SearchGraph()
        g = Graph(False)
        ...
        e5 = Edge(v3, v5, 1);  e6 = Edge(v4, v6, 1)
    ...
    def getG5(self): # Topological Sort
        g = Graph(True)
        v1 = Vertex("1"); v2 = Vertex("2");  v3 = Vertex("3"); v4 = Vertex("4");  v5 = Vertex("5");
        g.addVertex(v1);   g.addVertex(v2);   g.addVertex(v3);  g.addVertex(v4);  g.addVertex(v5);
        e1 = Edge(v1, v2, 1); e2 = Edge(v1, v3, 1)
        e3 = Edge(v2, v4, 1); e4 = Edge(v2, v5, 1);
        e5 = Edge(v3, v4, 1); e6 = Edge(v4, v5, 1)
        g.addEdge(e1)
        g.addEdge(e2)
        g.addEdge(e3)
        g.addEdge(e4)
